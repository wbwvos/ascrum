<?php 
	...
	$spelers = getPlayersPerPosition('3', $db);
?>
...
<body>
    ...
    <section id="about-us">
        <div class="container">
			...
			<div>
			<center>
					<img src="images/ascrumteamfoto3.jpg" class="img-responsive" alt="">
			</center>
			</div><!--/#about-slider-->
			<?php $result = parseScores('3');?>
			<h3>Leaderboard</h3>
			...
			<?php
				$coaches = array();
				$captains = array('Captain' => 'Wieb de Boer');
