<?php 
	...
	$spelers = getPlayersPerPosition('4', $db);
?>

<!DOCTYPE html>
<html lang="en">
<?php echoHead('AA 4e XV');?>
    ...
    <section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown">
				<h2>Ascrum AA (4<sup>e</sup> XV)</h2>
			...
			<div>
					<center><img src="images/ascrumteamfotoaa.jpg" class="img-responsive" alt=""></center>
			</div><!--/#about-slider-->
			<?php $result = parseScores('4');?>
			<h3>Leaderboard</h3>
			...
			<?php
				$coaches = array();
				$captains = array('Captain' => 'Maarten Richel');
