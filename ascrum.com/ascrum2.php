<?php 
	...
	$spelers = getPlayersPerPosition('2', $db);
?>
    ...
    <section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown">
				<h2>Ascrum 2<sup>e</sup> XV</h2>
				<!--<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>-->
			</div>
			
			<!-- about us slider -->
			<div>
					<center><img src="images/ascrumfoto3.jpg" class="img-responsive" alt=""></center>
			</div><!--/#about-slider-->
			<?php $result = parseScores('2');?>
			<h3>Leaderboard</h3>
			...
			<!-- Namen en Positie -->
				<?php
				$coaches = array('Coach' => 'Hans Poolman');
				$captains = array('Captain' => 'Michiel Nieuwenhuis');
